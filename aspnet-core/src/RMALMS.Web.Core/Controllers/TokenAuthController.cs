...
using Abp.UI;
using RMALMS.Authentication.External;
...
namespace RMALMS.Controllers
{
    ...
    public class TokenAuthController : RMALMSControllerBase
    {
        ...
        private async Task<AbpLoginResult<Tenant, User>> GetLoginResultGoogleAsync(string token, string tenancyName)
        {
