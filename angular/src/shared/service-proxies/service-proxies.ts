...
export class UserServiceProxy {
    ...
    getUsersByTenantId(tenantId, skipCount, maxResultCount): Observable<ResponseModel<UserDto[]>> {
        const httpParam = new HttpParams()
            .set('tenantId', tenantId).set('skipCount', skipCount).set('maxResultCount', maxResultCount);
        return this.http.get<ResponseModel<UserDto[]>>(
            this.baseUrl + '/api/services/app/User/GetUsersByTenantIdAsync',
            { params: httpParam }
        );
    }
  ...
  * @return Success
  */
    // getUsersByTenantId(tenantId: number | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfUserDto> {
    //     let url_ = this.baseUrl + "/api/services/app/User/GetUsersByTenantIdAsync?";
    ...
    resetPassword(input: ResetPasswordUserDto | null | undefined) {
        let url_ = this.baseUrl + "/api/services/app/User/ResetPasswordAsync";
        url_ = url_.replace(/[?&]$/, "");
    ...
    //ChangePasswordAsync
    public changePassword(input: ChangePasswordDto): Observable<ResponseResultModel<boolean>> {
        return this.http.post<ResponseResultModel<boolean>>(this.baseUrl + '/api/services/app/User/ChangePasswordAsync', input);
    }

    // DeleteAdminWithTenantId
    public DeleteAdmin(userId: number, tenantId: number): Observable<ResponseResultModel<boolean>> {
        return this.http.post<ResponseResultModel<boolean>>(this.baseUrl + '/api/services/app/User/DeleteAdminWithTenantId', { id: userId, tenantId: tenantId });
    }

    // GetAdminWithTenantId
    public GetAdminWithTenantId(userId: number, tenantId: number): Observable<ResponseResultModel<UserDto>> {
        return this.http.post<ResponseResultModel<UserDto>>(this.baseUrl + '/api/services/app/User/GetAdminWithTenantId', { id: userId, tenantId: tenantId });
    }

    // GetRolesByTenantId
    public GetRolesByTenantId(tenantId: number): Observable<ResponseModel<RoleDto[]>> {
        return this.http.post<ResponseModel<RoleDto[]>>(this.baseUrl + '/api/services/app/User/GetRolesByTenantId', { id: 0, tenantId: tenantId });
    }

    protected processResetPassword(response: HttpResponseBase) {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class UserDto implements IUserDto {
    ...
    creater: CreateUserDto;
    creatorName: string | undefined;
    isCreatedByRoot: boolean;
...
export class ResetPasswordUserDto implements IResetPasswordUserDto {
    id: number;
    //username: string;
    newPassword: string;
    tenantId: number;
    constructor(data?: IResetPasswordUserDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ResetPasswordUserDto {
        data = typeof data === 'object' ? data : {};
        let result = new ResetPasswordUserDto();
        result.init(data);
        return result;
    }
...
export interface IResetPasswordUserDto {
    id: number;
    newPassword: string;
    //username: string;
}
