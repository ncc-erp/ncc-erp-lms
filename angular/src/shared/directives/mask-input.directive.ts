...
export class MaskInputDirective {
  ...
  @Input('maskInput') appInputRestriction: string;
  arabicRegex = '[\u0600-\u06FF]';
  ...
  @HostListener('paste', ['$event']) onPaste(event) {
    ...
    let m;
    let matches = 0;
    //console.log('regex.exec(pasteData)', regex.exec(pasteData));
...
// Usage:
// <input type="text" maskInput="noSpecialChars" >
// <input type="text" maskInput="integer">
