...
import { ServerInterceptService } from '@shared/service-intercept/server-intercept.service';
...
@NgModule({
  imports: [
    ...
    NgxLoadingModule.forRoot({
      ...
      backdropBackgroundColour: 'rgba(0,0,0,0.80)',
  ...
  providers: [
    ...
    { provide: HTTP_INTERCEPTORS, useClass: ServerInterceptService, multi: true },
